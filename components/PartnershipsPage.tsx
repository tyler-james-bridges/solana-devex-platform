  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-200 p-4 sm:p-6">
      ...
      <div className="mt-12 bg-white dark:bg-gray-800 rounded-lg border dark:border-gray-700 p-6">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Integration Resources</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="text-center">
            ...
            <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Live Platform</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
      ...
      {/* Contact */}
      <div className="mt-8 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800 p-6 text-center">
