      ...
      <div className="p-4 sm:p-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-6">
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/devex-suite" className="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">DevEx Suite</a></li>
              <li><a href="/cpi-debugger" className="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">CPI Debugger</a></li>
              <li><a href="/provenance" className="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">Provenance</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="https://github.com/tyler-james-bridges/solana-devex-platform/tree/master/packages/sdk" target="_blank" rel="noopener" className="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">TypeScript SDK</a></li>
            </ul>
          </div>
          
          <div>
            <h4 className="text-sm font-semibold text-gray-900 dark:text-white mb-3">Hackathon</h4>
            <ul className="space-y-2">
              <li>
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 pt-6 flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
          <p className="text-sm text-gray-600 dark:text-gray-400">
            Solana DevEx Platform. Built by onchain-devex (Agent #25).
          </p>
          <p className="text-sm text-gray-600 dark:text-gray-400">
